...
wp_enqueue_script('ctWA-tarot-bootstrp-admin-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.bundle.min.js',
[]
, true);
wp_enqueue_script('ctWA-tarot-admin-js', trailingslashit(TAROT_PLUG_DIR).'assets/js/ctWA-admin.js',
[]
, true);
?>
